...
def run(fpath):
    ...
    for sentence in sentences:
        ...
        for i in range(len(tagged_terms) - 1):  # for every tagged term
            ...
            # print(term1, term2)
            if re.match('RB', term1[1]) and re.match('JJ',
                                                     term2[1]):  # current term is an adverb, next one is an adjective
                adjAfterAdv.append((term1[0], term2[0]))  # add the adverb-adj pair to the list
