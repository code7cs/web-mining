...
# use the function
# The function should return the number of lines in the text file that include each word.
print(run('textfile', 'blue', 'yellow'))
print(run('textfile', 'name', 'kate'))
print(run('textfile', 'house', 'kate'))
